...
class Volum(db.Model):
	__tablename__ = 'volum'
	volId = db.Column(db.Integer, primary_key=True, autoincrement=True)
	novelId = db.Column(db.Integer, nullable=False)
...
class Section(db.Model):
	...
	secId = db.Column(db.Integer, primary_key=True, autoincrement=True)
	volId = db.Column(db.Integer, nullable=False)
